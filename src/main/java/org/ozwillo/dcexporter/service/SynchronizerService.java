...
public class SynchronizerService {
    ...
    private void sync(DcModelMapping dcModelMapping) {
        ...
        if (StringUtils.isEmpty(dcModelMapping.getPivotField())) {
            ...
            creatingResouce(dcModelMapping, null, ckanResourceIdKey, ckanResourceName);
            ...
            resourcesByPivotValues.forEach((pivotValue, dcResources) -> {
                ...
                creatingResouce(dcModelMapping, pivotValue, ckanResourceIdKey, ckanResourceName);
    ...
    private void creatingResouce(DcModelMapping dcModelMapping, String pivotValue, String ckanResourceIdKey, String ckanResourceName) {
        if (dcModelMapping.getCkanResourceId().get(ckanResourceIdKey) == null) {
